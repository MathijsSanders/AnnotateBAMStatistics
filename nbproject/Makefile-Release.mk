...
${OBJECTDIR}/Algorithm.o: Algorithm.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -I./samtools -std=c++0x -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Algorithm.o Algorithm.cpp

${OBJECTDIR}/AnnovarFile.o: AnnovarFile.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -I./samtools -std=c++0x -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AnnovarFile.o AnnovarFile.cpp

${OBJECTDIR}/BamFile.o: BamFile.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -I./samtools -std=c++0x -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BamFile.o BamFile.cpp

${OBJECTDIR}/Mutex.o: Mutex.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -I./samtools -std=c++0x -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Mutex.o Mutex.cpp

${OBJECTDIR}/main.o: main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -I./samtools -std=c++0x -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
